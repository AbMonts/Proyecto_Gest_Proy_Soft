    ...
    public class Inventarios
    {
        ...
        public DataTable seleccionar()
        {
            ...
            try
            {
                ...
                string query = "SELECT id_inventario, inventario_nombre_corto, inventario_descripcion, inventario_serie, inventario_color, inventario_fecha_adquisicion, inventario_tipo_adquisicion, inventario_observaciones, id_area FROM inventario";
        ...
        public bool actualizar(Inventarios i)
        {
            MySqlTransaction tran = null;
            bool res = true;
            string query = "update inventario set inventario_nombre_corto = @nombre, inventario_descripcion = @descripcion, inventario_serie = @serie, inventario_color = @color, inventario_fecha_adquisicion = @fecha, inventario_tipo_adquisicion = @tipo, inventario_observaciones = @observaciones, id_area = @area_id where id_inventario = @id";
