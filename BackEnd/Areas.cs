...
namespace Proyecto_1.BackEnd
{
    public class Areas
    {
        ...
        public bool eliminar(Areas a)
        {
            MySqlTransaction tran = null;
            bool res = true;
            string query = "delete from areas where id_area = @id";
        ...
        public bool actualizar(Areas a)
        {
            MySqlTransaction tran = null;
            bool res = true;
            string query = "update areas set area_nombre = @nombre, area_ubicacion = @ubicacion where id_area = @id";
        ...
        {
            bool u = false;
            string query = "select id_area from areas where id_area = @id";
